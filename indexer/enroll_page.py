...
def render(*, now=None) -> str:
    ...
    body = (
        ...
        "N</code>). It buys and burns once the coin has graduated to the "
        "pump AMM, which is where it can be bought; on the bonding curve the "
        "SOL simply accrues in that wallet until then.</p>"
